...
st.caption("Zepp + Health Connect Analytics")
...
sleep_df = safe_load_csv("sleep.csv")
activity_df = safe_load_csv("activity.csv")
heart_df = safe_load_csv("heart_rate.csv")
workout_df = safe_load_csv("workouts.csv")
...
if not sleep_df.empty:
    ...
    if start_col and end_col:
        ...
        sleep_daily = (
            sleep_df.groupby("date")["sleep_hours"]
            .mean()
            .reset_index()
        )
...
overview_tab, sleep_tab, activity_tab, recovery_tab, correlation_tab = st.tabs([
    "Overview",
    "Sleep",
    "Activity",
    "Recovery",
